...
mean_plot_family <- ggplot(summary_stats, aes(x = Species.Label, y = mean_flux , 
                                              fill = family_order)) +
...
mean_plot_family_discrete <- ggplot(summary_stats, aes(x = Species.Label, y = mean_flux , 
                                                       fill = family)) +
  geom_bar(stat = "identity", color = "black") +
  geom_errorbar(aes(ymin = (mean_flux - se_flux) , ymax = (mean_flux + se_flux) ),
                width = 0.2) +
...
mean_plot_custom_colors <- ggplot(summary_stats, aes(x = Species.Label, y = mean_flux , 
                                                     fill = family)) +
  geom_bar(stat = "identity", color = "black") +
  geom_errorbar(aes(ymin = (mean_flux - se_flux) , ymax = (mean_flux + se_flux) ),
                width = 0.2) +
...
mean_plot_met <- ggplot(summary_stats, aes(x = Species.Label, y = mean_flux , 
                                           fill = family)) +
  geom_bar(stat = "identity", color = "black") +
  geom_errorbar(aes(ymin = (mean_flux - se_flux) , ymax = (mean_flux + se_flux) ),
                width = 0.2) +
